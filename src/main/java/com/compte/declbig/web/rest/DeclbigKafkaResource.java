...
@RestController
@RequestMapping("/api/declbig-kafka")
public class DeclbigKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DeclbigKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DeclbigKafkaResource(KafkaProperties kafkaProperties) {
